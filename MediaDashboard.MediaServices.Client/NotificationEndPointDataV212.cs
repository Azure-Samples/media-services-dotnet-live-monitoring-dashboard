namespace Microsoft.WindowsAzure.MediaServices.Client
{
    ...
    [DataServiceKey("Id")]
    internal class NotificationEndPointDataV212 : BaseEntity<INotificationEndPointV212>, INotificationEndPointV212
    {
        private string _id;
        private string _name;
        private NotificationEndPointTypeV212 _endPointType;
        private string _endPointAddress;

        /// <summary>
        /// Don't allow the customer to create a default NotificationEndPoint object.
        /// </summary>
        public NotificationEndPointDataV212()
        {
        }

        public NotificationEndPointDataV212(string name, NotificationEndPointType endPointType, string endPointAddress)
        {
            _id = string.Empty;
            Name = name;
        ...
        public NotificationEndPointDataV212(string id, string name, NotificationEndPointType endPointType, string endPointAddress)
        {
            Id = id;
            Name = name;
            EndPointType = (int)endPointType;
        ...
        /// </summary>
        NotificationEndPointTypeV212 INotificationEndPointV212.EndPointType
        {
        ...
        public int EndPointType
        {
            ...
            set
            {
                ...
                _endPointType = (NotificationEndPointTypeV212)endPointTypeValue;
            }
        }
